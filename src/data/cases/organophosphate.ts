...
export const SCAFFOLD_ORGANOPHOSPHATE: CaseScaffold = {
  ...
  therapiesMap: {
    ...
    pralidoxime: {
      ...
      appropriateness: 'indicated',
      rationale:
        'Pralidoxime reactivates acetylcholinesterase and treats the nicotinic picture — muscle weakness and fasciculations — and reduces the risk of later neuromuscular complications. It does not relieve muscarinic symptoms (secretions, bronchospasm, bradycardia), which is atropine\'s job, so it should be added once atropine is running, not used to replace it. Its benefit also falls the longer it is delayed, since the enzyme-inhibitor bond becomes progressively less reversible with time.',
