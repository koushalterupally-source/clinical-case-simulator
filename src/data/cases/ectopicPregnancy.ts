...
export const SCAFFOLD_ECTOPIC: CaseScaffold = {
  ...
  investigationsMap: {
    urine_hcg: {
      aliases: ['urine pregnancy test', 'urine hcg', 'urine beta hcg', 'upt', 'pregnancy test urine'],
    ...
    serum_bhcg: {
      aliases: ['serum beta-hcg', 'quantitative beta-hcg', 'beta-hcg', 'serum hcg', 'bhcg', 'hcg level', 'quantitative hcg'],
    ...
    blood_group: {
      aliases: ['blood grouping & cross-match', 'blood grouping', 'cross match', 'blood group', 'type and crossmatch', 'grouping and crossmatch'],
    ...
    usg_pelvis: {
      aliases: ['usg abdomen & pelvis', 'usg pelvis', 'pelvic ultrasound', 'transvaginal ultrasound', 'pelvic usg', 'transvaginal usg', 'ultrasound abdomen pelvis', 'ultrasound pelvis'],
  ...
  therapiesMap: {
    ...
    anti_d: {
      aliases: ['anti-d immunoglobulin im', 'anti-d immunoglobulin', 'anti-d prophylaxis', 'anti-d', 'im anti d immunoglobulin'],
    ...
    methotrexate: {
      aliases: ['methotrexate im', 'methotrexate', 'im methotrexate'],
